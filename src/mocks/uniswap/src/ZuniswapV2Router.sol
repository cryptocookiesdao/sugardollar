...
contract ZuniswapV2Router {
    ...
    constructor(address factoryAddress, address weth) {
    ...
    function addLiquidity(
        ...
        return addLiquidity(tokenA, tokenB, amountADesired, amountBDesired, amountAMin, amountBMin, to);
    }
    ...
    function swapExactTokensForTokens(
        ...
        return swapExactTokensForTokens(amountIn, amountOutMin, path, to);
    }
        ...
        returns (uint256[] memory amounts)
    {
        ...
        _safeTransferFrom(
            path[0], msg.sender, ZuniswapV2Library.pairFor(address(factory), path[0], path[1]), amounts[0]
        );
    ...
    function _calculateLiquidity(
        ...
        (uint256 reserveA, uint256 reserveB) = ZuniswapV2Library.getReserves(address(factory), tokenA, tokenB);
